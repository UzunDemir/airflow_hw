...
def pipeline() -> None:
    # import os
    # for f in os.listdir("opt/airflow"):
    #     print(f)
    #print(path)
    #path = 'C:/Users/HP Z2/airflow_hw'
    #df = pd.read_csv(f'{path}/dags/data/train/homework.csv') #data/train/homework.csv
    path = 'opt/airflow/dags/'
    df = pd.read_csv('/opt/airflow/dags/data/train/homework.csv') #C:\Users\HP Z2\airflow_hw\dags\data\train\homework.csv

    # path = 'C:/Users/pro'
    # df = pd.read_csv(f'{path}/homework.csv')
    ...
    best_pipe.fit(X, y)
    model_filename = f'/opt/airflow/dags/data/models/cars_pipe_{datetime.now().strftime("%Y%m%d%H%M")}.pkl'
